...
-- NPC Spawn (Pershing Square - Belediye Karşısı)
local guideNPC = createPed(211, 1481.0, -1711.0, 14.1)
setElementRotation(guideNPC, 0, 0, 0)
...
setElementData(guideNPC, "rclick:option", "Desteğe İhtiyacım Var") -- Sağ tık menüsü için ipucu
