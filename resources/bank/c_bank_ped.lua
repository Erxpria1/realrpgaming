...
setElementData( atmPed, "rpp.npc.type", "bank.cards", false ) -- Added for Right Click

setElementData( generalServicePed, "name", "Jonathan Smith", false )
setElementData( generalServicePed, "rpp.npc.type", "bank.banking", false ) -- Added for Right Click
